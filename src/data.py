...
class Data:
    ...
    def mainwin(self):
        ...
        Label(root, text=self.s.reaction, font=('Times New Roman', fs), justify="center").pack()
        Label(root, height=2, background="gray").pack()
        Label(root, text=f"T={int(self.s.temp)} K", justify="center", font=('Times New Roman', fs), width=25).pack()
